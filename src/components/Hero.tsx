    ...
    <section className="hero">
      ...
      <div className="hero-content">
        <div className="hero-tag">
          <span className="dot" /> Beverly Grove • Mon to Sat 8AM–6PM · Sun 8AM–5PM
        </div>
        <h1>
        ...
        <p className="hero-desc">
          ...
          to detail, reduced risk of paint damage, personalized care. Washes from $31.99
        ...
        <div className="hero-photo-strip">
          ...
          <div className="hero-thumb"><img src="/majestic/detailing-bay.jpg" alt="Detailing bay" /></div>
