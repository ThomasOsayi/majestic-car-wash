const images = [
  ...
  { src: "https://images.unsplash.com/photo-1549317661-bd32c8ce0afa?w=500&q=80", alt: "Car wheel" },
];
    ...
    <section className="gallery" id="gallery">
      <div className="section-inner">
        ...
        <div className="gallery-mosaic reveal">
          {images.map((img) => (
            <div className={`gallery-cell${img.className ? ` ${img.className}` : ""}`} key={img.alt}>
